...
<div class="floatright">
 ...
 <div class="letter-nav">
			<ul class="fn-clear">
				...
				<li class="selected"><a targt="_blank" href="{{url('/home/msg/post')}}">我要反馈<i class="number"></i></a></li>
			</ul>
</div>		<!--信件导航 E-->
		<!--信件 B-->
		<div class="letter-mod">
			...
			<div class="letter-loading" id="letter-nodata3">
				<form method="get">
                    反馈内容：<input type="text" style="width: 500px;height: 30px;" name="text" placeholder="请输入反馈内容"><br><br>
                    邮&nbsp;&nbsp;箱：<input style="width: 500px;height: 30px;" type="email" name="email" placeholder="请输入您的邮箱"><br><br>
                    <!-- <input class="tijiao" style="margin-right: -50px;background-color: #D03060;width: 500px;height: 20px;" type="submit" value="提交"> -->
                    <button type="submit" id="tijiao" style="margin-right: -50px;background-color: #D03060;width: 500px;height: 20px;">提交</button>
                </form>
			</div>
