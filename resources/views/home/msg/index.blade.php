...
<link href="/home/css/jy_ad.css" rel="stylesheet" type="text/css" />
<link href="/home/css/jy_msg.css" rel="stylesheet" type="text/css" />
<link href="/home/css/lstter.css" rel="stylesheet" type="text/css" />
<link href="/home/css/msg_player.css" rel="stylesheet" type="text/css" />
...
<div class="cp-menu">
    ...
    <div class="cp-menu-card-user">
        ...
        <div class="cp-menu-card-mail fn-clear">
            <a class="menu menu-left" href="{{url('/home/msg/index')}}/{{4}}" onmousedown="send_jy_pv2('|cp_menu_area_msg|135859241');" title="未读信件封">
                <span>收件箱</span>
        ...
        <div class="cp-menu-index"><a class="menu" href="http://usercp.jiayuan.com/" onmousedown="send_jy_pv2('|cp_menus_index|');">我的佳缘首页</a></div>
            ...
            <div class="cp-menu-items fn-clear">
                ...
                <ul >
                                ...
                                <a class="menu" id="visitor_new_id" target="_self" href="{{url('/home/msg/index')}}" onmousedown="send_jy_pv2('|1012380_0| ');"  >
                                                                            <div class="cp-menu-item-name">谁看过我</div>                                       <div class="cp-menu-item-number">                                           <div class="cp-menu-radius fn-right">
                                                                                        <div id="visitor_new" class="cp-menu-radius-num" style='display:none'></div>
                                                                                                                                                                                                                ...
                                                                                                                                                                                                                <li class=" ">
                                <a class="menu" id="click_new_id" target="_self" href="{{url('/home/msg/index')}}" onmousedown="send_jy_pv2('|1012380_3| ');"  >
                                                                            <div class="cp-menu-item-name">我看过谁</div>                                       <div class="cp-menu-item-number">                                           <div class="cp-menu-radius fn-right">
                                                                                        <div id="click_new" class="cp-menu-radius-num" style='display:none'></div>
                                                                                                                                                                                                                ...
                                                                                                                                                                                                                <li class=" ">
                                <a class="menu" id="fans_new_id" target="_self" href="{{url('/home/msg/index')}}" onmousedown="send_jy_pv2('|1012380_2| ');"  >
                                                                            <div class="cp-menu-item-name">谁关注我</div>                                       <div class="cp-menu-item-number">                                           <div class="cp-menu-radius fn-right">
                                                                                        <div id="fans_new" class="cp-menu-radius-num" style='display:none'></div>
                                                                                                                                                                                                                ...
                                                                                                                                                                                                                <li class=" ">
                                <a class="menu" id="menu_id_fate" target="_blank" href="{{url('/home/topic/index')}}" onmousedown="send_jy_pv2('|cp_menus_app_fate|');"  >
                            ...
                            <li>
                             <a class="menu" id="menu_id_fate" target="_blank" href="{{url('/home/search/index')}}" onmousedown="send_jy_pv2('|cp_menus_app_fate|');"  >
                                                                            <div class="cp-menu-item-name">搜索会员</div>                                       <div class="cp-menu-item-number">                                           <div class="cp-menu-radius fn-right">
                                                                                        <div id="app_id_fate" class="cp-menu-radius-num" style='display:none'></div>
                                        </div>
                                    </div>
                                                                    </a>
...
<div class="floatright">
 ...
 <div class="letter-nav">
			<ul class="fn-clear">
				<li class="selected"><a onmousedown="send_jy_pv2('|1015897_2|147927769');" href="{{url('/home/msg/index')}}">未读信</a></li>
				<li><a onmousedown="send_jy_pv2('|1015940_2|147927769');" href="{{url('/home/msg/inbox')}}">已读信<i class="number"></i></a></li>
				<li><a onmousedown="send_jy_pv2('|1015946_2|147927769');" href="{{url('/home/msg/outbox')}}">已发信<i class="number"></i></a></li>
				
				<li><a href="{{url('/home/msg/admin')}}">管理员信<i class="number">1</i></a></li>
				<li><a targt="_blank" href="{{url('/home/msg/post')}}">我要反馈<i class="number"></i></a></li>
			</ul>
</div>		<!--信件导航 E-->
		<!--信件 B-->
		<div class="letter-mod">
			...
			<!--营销-->
			<div id="ad_pos_67"><div class="item promotions fn-clear"><div class="avatar-pic"><a href="{{url('/home/myqianyuan/recharge')}}"><img alt="" src="/home/img/zhuanti1470713937188.jpg"></a></div><div class="con-mod"><h3 class="msg-title"><a target="_blank" href="{{url('/home/myqianyuan/recharge')}}">专享钻石会员仅1.1折！</a></h3><p class="msg-txt"><a target="_blank" href="{{url('/home/myqianyuan/recharge')}}">钻石会员12个月直减500！无限量看信，发信被免费看，送VIP会员12个月！</a></p></div><div class="msg-btn"><a target="_blank" href="{{url('/home/myqianyuan/recharge')}}">查看详情</a></div></div>
			</div>
			<!--信件列表-->
			
			@foreach($datamsg as $data)
			<div class="letter-list" id="letter-list"><div jump="0" class="item fn-clear"><input type="hidden" value="http://www.jiayuan.com/msg/showmsg.php?obj_uid_disp=npx6zFRhTZV17EGxL8uk1M8Z0odeuVLMno8mEkyOhNBctc6x-*iTQU0.&amp;page_index=x/1/10/3/1&amp;sort=101&amp;box_type=inbox&amp;msg_type=" class="show_link_input"><input type="hidden" value="http://www.jiayuan.com/msg/v7/shownewmsg.php?kanxin=0.3&amp;putong=0&amp;obj_uid_disp=npx6zFRhTZV17EGxL8uk1M8Z0odeuVLMno8mEkyOhNBctc6x-*iTQU0.&amp;page_index=x/1/10/3/1&amp;sort=101&amp;box_type=inbox" class="jump_link_input"><div class="input-mod"><input type="checkbox" pnum="3" tit="1/10/3/1" value="npx6zFRhTZV17EGxL8uk1M8Z0odeuVLMno8mEkyOhNBctc6x-*iTQU0." class="m-input" msg_type="" admin="0" onmousedown="send_jy_pv2('|1015897_33|147927769');"></div><div class="avatar-pic more-pic"><a onmousedown="send_jy_pv2('|1015897_17|147927769');" href="http://www.jiayuan.com/msg/v7/shownewmsg.php?kanxin=0.3&amp;putong=0&amp;obj_uid_disp=npx6zFRhTZV17EGxL8uk1M8Z0odeuVLMno8mEkyOhNBctc6x-*iTQU0.&amp;page_index=x/1/10/3/1&amp;sort=101&amp;box_type=inbox" target="_blank" class="pay_btn"><img alt="" src="{{$data -> img}}"><span title="对方有真实照片，诚意征友" class="pic-num">3</span></a></div><div class="con-mod"><div class="specific"><a onmousedown="send_jy_pv2('|1015897_19|147927769');" href="http://www.jiayuan.com/msg/v7/shownewmsg.php?kanxin=0.3&amp;putong=0&amp;obj_uid_disp=npx6zFRhTZV17EGxL8uk1M8Z0odeuVLMno8mEkyOhNBctc6x-*iTQU0.&amp;page_index=x/1/10/3/1&amp;sort=101&amp;box_type=inbox" target="_blank" class="name pay_btn">
				@if($data -> sex == '0')
					男
				@else
					女
				@endif
			</a>&nbsp;<a onmousedown="send_jy_pv2('|1015897_21|147927769');" href="http://www.jiayuan.com/msg/v7/shownewmsg.php?kanxin=0.3&amp;putong=0&amp;obj_uid_disp=npx6zFRhTZV17EGxL8uk1M8Z0odeuVLMno8mEkyOhNBctc6x-*iTQU0.&amp;page_index=x/1/10/3/1&amp;sort=101&amp;box_type=inbox" class="data pay_btn" target="_blank">{{$data -> age}}岁，
				@if($data -> marray == '0')
					未婚
				...
				@elseif($data -> marray == '2')
					离异
				@elseif($data -> marray == '3')
					丧偶
				@endif
			，{{$data -> city}}，{{$data -> height}}cm</a></div><div class="time"><span>{{$data -> content}}&nbsp;{{date('Y年m月d日 H:i:s', $data->addtime)}}</span></div></div><div class="msg"></div><div class="msg-btn orange "><a href="{{'/home/msg/detail'}}" target="_blank" class="pay_btn">看信</a><div class="replay-btn-layer"><span class="tarr-icon"></span></div></div></div>
			</div>
			@endforeach
		
			<div style="display:none;color:#666" class="letter-loading" id="letter-nodata">
				暂无未读信<br><br>
				爱情需要主动出击，搜索喜欢的人，主动联系他们吧！
			</div>
		
			<div style="display:none" class="letter-loading" id="letter-nodata2">
                巧了，本页的发信人全部交友成功了。请继续翻页吧~
            </div>
            <div style="display:none" class="letter-loading" id="letter-nodata3">
				暂无记录
			</div>
			<div style="display:none" class="letter-loading" id="letter-nodata3">
				暂无记录
