        ...
        <div class="cp-menu-index"><a class="menu" href="http://usercp.jiayuan.com/" onmousedown="send_jy_pv2('|cp_menus_index|');">我的佳缘首页</a></div>
            ...
            <div class="cp-menu-items fn-clear">
                ...
                <ul >
                                                                                                                                                                                                                ...
                                                                                                                                                                                                                <li class=" ">
                                <a class="menu" id="friends_1" target="_self" href="{{url('/home/msg/index')}}/{{4}}" onmousedown="send_jy_pv2('Usercpn_friends_0');"  >
                                                                            <div class="cp-menu-item-name">好友与联系人</div>                                     <div class="cp-menu-item-number">                                           <div class="cp-menu-radius fn-right">
                                                                                        <div id="friends" class="cp-menu-radius-num" style='display:none'></div>
                                                                                                                                                                                                                ...
                                                                                                                                                                                                                <li class=" ">
                                <a class="menu" id="visitor_new_id" target="_self" href="{{url('/home/msg/index')}}/{{4}}" onmousedown="send_jy_pv2('|1012380_0| ');"  >
...
<div class="floatright">
 ...
 <div class="letter-nav">
            <ul class="fn-clear">
                <li><a onmousedown="send_jy_pv2('|1015897_2|147927769');" href="{{url('/home/msg/index')}}">未读信</a></li>
                <li class="selected"><a onmousedown="send_jy_pv2('|1015940_2|147927769');" href="{{url('/home/msg/inbox')}}">已读信<i class="number"></i></a></li>
