	...
	<div class="info_content">
		...
		<div class="info_left">
			<ul>
				...
				<li class="ok" onmousedown="send_jy_pv2('editprofile|category_note|m|135859241');"><a href="http://www.jiayuan.com/usercp/note.php">基本资料</a>
			...
			<div class="base_info">
				...
				<table colspan = "3" width="450" cellpadding="0" cellspacing="0" class="f-table">
					...
					<tr>
						...
						<td>
							 <select name="education" id="marriage" style="color:#666;">
								
								<option label="高中及以下" value="1">高中及以下</option>
								<option label="有小孩归自己" value="2">大专</option>
								<option label="有小孩归对方" value="3">本科</option>
								<option label="有小孩归对方" value="4">双学士</option>
								<option label="有小孩归对方" value="5">硕士</option>
								<option label="有小孩归对方" value="6">博士</option>
								<option label="有小孩归对方" value="7">博士后</option>
					...
					<tr>
						...
						<td>
							 <select name="marray" id="marriage" style="color:#666;">
								
								<option label="无小孩" value="0">未婚</option>
								<option label="有小孩归自己" value="1">离异</option>
								<option label="有小孩归对方" value="2">丧偶</option>
					...
					<tr>
						...
						<td>
							<select name="nation" id="nation">
									...
									<option label="其它民族" value="10">其它民族</option>
					...
					<tr>
						...
						<td>
							...
							<select id="income" name="income" onChange="validate('income', this.value)">
								<option label="2000元以下" value="0">2000元以下</option>
								<option label="2000～5000元" value="1">2000～5000元</option>
								<option label="5000～10000元" value="2">5000～10000元</option>
								<option label="10000～20000元" value="3">10000～20000元</option>
								<option label="20000～50000元" value="4">20000～50000元</option>
