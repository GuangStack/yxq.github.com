                        ...
                        <form role="form" action="{{ url('/admin/success/insert') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="manname"  class="form-control" id="exampleInputEmail1"
                                           placeholder="请输入女方姓名">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">男方姓名</label>
                                    <input type="text" name="womanname" class="form-control" id="exampleInputPassword1"
                                           placeholder="请输入男方姓名">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="introduce" class="form-control" id="exampleInputPassword1"
                                           placeholder="请输入简介">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="type">
                                        <option value="0" selected="selected">一波三折</option> 
                                        <option value="1" selected="selected">郎才女貌</option>
                                        <option value="2" selected="selected">一见钟情</option> 
                                        <option value="3" selected="selected">90后</option>  
                                    </select>
