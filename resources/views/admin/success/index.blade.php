                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">快速查看成功故事</h3>
                        </div><!-- /.box-header -->
                        <div class="box-body">
                            <div class="row">
                            ...
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <tr>
                                    <td>{{ $success -> id }}</td>
                                    <td>{{ $success -> manname }}</td>
                                    
                                    <td>{{ $success -> womanname }}</td>
                                    <td>{{ $success -> title }}</td>
                                    <td>{{ $success -> type }}</td>
                                    <td>{{ date('Y-m-d',$success -> time) }}</td>
                                    <td>{{ date('Y-m-d',$success -> addtime) }}</td>

                                    <td><img width="50" src="{{ $success -> image }}"></td>
                                    <td>
                                    
                                        <a href="{{ url('/admin/success/edit') }}/{{ $success -> id }}">编辑</a>|
                                        <a href="{{ url('/admin/success/delete') }}/{{ $success -> id }}">删除</a>
                                    </td>
                                </tr>
                                @endforeach
                                </tbody>
